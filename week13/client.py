...
if __name__ == '__main__':
    ...
    parser.add_argument('--address', type=str, default='127.0.0.1', help='The address to send data')
    parser.add_argument('--port', type=int, default=38443, help='The port to send data')
    parser.add_argument('--chunk_maxsize', type=int, default=2**16, help='The recvfrom chunk max size')
